...
// page functions.
//
function check_sql_permissions($sql, $user_id, $db_id)
{
...
SQL_QUERY;
  ...
  //
  #$query = 'grant all on ' . quoteIdentifier($db_name) . '.* to ?@localhost identified by ?';
...
// dynamic page data.
//
check_sql_permissions($sql, $_SESSION['user_id'], $db_id);
