            ...
            <tr>
              <td valign="top"><table width="100%" cellpadding="5" cellspacing="5">
				...
				<!-- BDP: pusres -->
				  ...
				  <tr>
				    <td>&nbsp;</td>
				    <td colspan="4"><input name="Button" type="button" class="button" onClick="MM_goToURL('parent','puser_uadd.php');return document.MM_returnValue" value="{TR_ADD_USER}">				      </td>
				    </tr></table>
				  </td>
              <td>&nbsp;</td>
            </tr>
            ...
            <tr>
              <td valign="top"><table width="100%" cellpadding="5" cellspacing="5">
                  ...
                  <!-- EDP: pgroups -->
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="3">                        <input name="Button" type="button" class="button" value="{TR_ADD_GROUP}" onClick="MM_goToURL('parent','puser_gadd.php');return document.MM_returnValue"></td>
                    </tr>
              </table></td>
              <td>&nbsp;</td>
            </tr>
