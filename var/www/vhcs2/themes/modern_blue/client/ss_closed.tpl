                ...
                <tr>
                  ...
                  <td valign="top"><table width="100%" cellspacing="7">
                    ...
                    <tr>
                      ...
                      <td class="{CONTENT}" nowrap><img src="{THEME_COLOR_PATH}/images/icons/document.gif" width="12" height="15" align="left"> <a href="view_ticket.php?ticket_id={ID}" class="link">{SUBJECT}</a></td>
