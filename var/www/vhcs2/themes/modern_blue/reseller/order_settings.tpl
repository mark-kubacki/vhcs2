        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" cellpadding="5" cellspacing="5">
              ...
              <tr>
                <td>&nbsp;</td>
                <td class="content"><textarea name="header" rows="15" class="textinput2" id="header" style="width:580px">
				<!-- BDP: purchase_header -->
				<!-- EDP: purchase_header -->
				</textarea></td>
              </tr>
              ...
              <tr>
                <td width="20">&nbsp;</td>
                <td class="content"><textarea name="footer" rows="15" class="textinput2" id="footer" style="width:580px">
				<!-- BDP: purchase_footer -->
				<!-- EDP: purchase_footer -->
				</textarea></td>
              </tr>
