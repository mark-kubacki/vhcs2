  ...
  <tr>
    <td height="551"><table width="100%"  border="00" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td height="348" align="center" background="/vhcs2/themes/modern_blue/images/login/content_background.gif">
		  <table width="600" height="200" border="00" cellpadding="1" cellspacing="3" bgcolor="#FF0000">
            <tr>
              <td align="center" bgcolor="#FFFFFF" class="title"><strong><font color="#FF0000">{MESSAGE}</font></strong></td>
            </tr>
          </table>
		</td>
      </tr>
      ...
      <tr>
        ...
        <td bgcolor="#334163"><a href="http://www.vhcs.net" target="_blank"><img src="/vhcs2/themes/modern_blue/images/login/vhcs_logo.gif" alt="VHCS - Virtual Hosting Control System - Control Panel" width="68" height="60" border="0"></a><br><span class="login_bottom">{TR_VHCS_LICENSE}</span></td>
        </tr>
    </table></td>
  </tr>
</table>
